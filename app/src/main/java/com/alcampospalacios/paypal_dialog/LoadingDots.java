...
public class LoadingDots extends LinearLayout {
    ...
    private int color_paypal_first;
    private int color_paypal_second;
    private int color_paypal_third;
    ...
    private void initializeDots(Context context) {
        ...
        LayoutParams spaceParams = new LayoutParams(mDotSpace, mDotSize);
            ...
            // Add dot
            View dotView = createDotView(context, color_paypal_first);
            addView(dotView, dotParams);
            mDots.add(dotView);
            // Add space
            addView(new View(context), spaceParams);
        // Add dot
        View dotView2 = createDotView(context, color_paypal_second);
        addView(dotView2, dotParams);
        mDots.add(dotView2);
        // Add space
        addView(new View(context), spaceParams);
        // Add dot
        View dotView3 = createDotView(context, color_paypal_third);
        addView(dotView3, dotParams);
        mDots.add(dotView3);
